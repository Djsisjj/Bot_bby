...
"https://i.postimg.cc/J7Qvbzc1/zpbi-Yu-P1-WBTUrc.jpg",
   ...
   var callback = () => api.sendMessage({body:`KING OF VIRTUAL -JAHANGIR ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/ache/1.jpg"));  
