module.exports.config = {
    ...
    var h = e.threadID,
        l = ["𝗕𝗲𝘀𝗵𝗶 𝗱𝗮𝗸𝗹𝗲 𝗮𝗺𝗺𝘂 𝗯𝗼𝗸𝗮 𝗱𝗲𝗯𝗮 𝘁𝗼__🥺", "__বেশি বেবি বললে কামুর দিমু,,//🤭🤭", "𝗕𝗯𝘆 𝗻𝗮 𝗯𝗼𝗹𝗲 𝗕𝗼𝘄 𝗯𝗼𝗹𝗼😘","এই এই তোর পরীক্ষা কবে ? শুধু 𝗕𝗯𝘆 𝗯𝗯𝘆 𝗸𝗼𝗿𝗶𝘀😾","আমার সোনার বাংলা ,তারপরে লাইন কি ?🙈","🍺 এই নাও জুস খাও..!𝗕𝗯𝘆 বলতে বলতে হাপায় গেছো না🥲","হটাৎ আমাকে মনে পড়লো,,🙄","𝗛𝗲𝘆 𝗛𝗮𝗻𝗱𝘀𝗼𝗺𝗲 𝗯𝗼𝗹𝗼😁😁","আরে Bolo আমার জান ,কেমন আসো?😚","একতা 𝑩𝑭 খুঁজে দাও😿","আগে একটা গান বলো,☹নাহলে কথা বলবো না_🥺","বলো কি করতে পারি তোমার জন্য😚","°কথা দেও আমাকে পটাবা...!!😌","বার বার Disturb করেছিস কোনো😾,আমার জানু এর সাথে ব্যাস্ত আসি😋" , "আমাকে না দেকে একটু পড়তেও বসতে তো পারো🥺🥺 " , "বার বার ডাকলে মাথা গরম হয় কিন্তু😑😒 " , "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে,,BADBOY ,BADBOY ও তো করতে পারো😑😒" , "বলো জানু 🌚 " , "কি হলো ,মিস টিস করচ্ছিস নাকি🤣" , "Bolo Babu, তুমি কি আমাকে ভালোবাসো? 🙈" , "আজকে আমার mন ভালো নেই🙉"]
        u = l[Math.floor(Math.random() * l.length)];
    ["bby","bby","bby oi","iove bot","maliha"].forEach((e => {
